...
calculateDistance(start, end) // Function to..
{
    startXY = (start[0] , start[1], 0);
    endXY = (end[0], end[1], 0);

    return Distance(startXY, endXY);
}
calculate3Distance(start, end)
{
    return Distance(start, end);  // Use all three coordinates: X, Y, and Z
}
