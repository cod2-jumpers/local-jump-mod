...
onMenuResponse()
{
	for(;;)
	{
		...
		else if(!level.xenon)
		{
			...
			else if(menu==game["menu_jumper"])
				maps\mp\gametypes\_quickmessages::jumper(response);
				
			else if(menu==game["menu_pistoll"])
				maps\mp\gametypes\_quickmessages::pistoll(response);
				
			else if(menu==game["menu_settings"])
				maps\mp\gametypes\_quickmessages::settings(response);
